...
/* loaded from: input.aar:classes.jar:org/webrtc/CameraEnumerationAndroid.class */
public class CameraEnumerationAndroid {
    ...
    /* loaded from: input.aar:classes.jar:org/webrtc/CameraEnumerationAndroid$CaptureFormat.class */
    public static class CaptureFormat {
        ...
        /* loaded from: input.aar:classes.jar:org/webrtc/CameraEnumerationAndroid$CaptureFormat$FramerateRange.class */
    ...
    /* loaded from: input.aar:classes.jar:org/webrtc/CameraEnumerationAndroid$ClosestComparator.class */
    ...
    public static CaptureFormat.FramerateRange getClosestSupportedFramerateRange(List<CaptureFormat.FramerateRange> supportedFramerates, final int requestedFps) {
        return (CaptureFormat.FramerateRange) Collections.min(supportedFramerates, new ClosestComparator<CaptureFormat.FramerateRange>() { // from class: org.webrtc.CameraEnumerationAndroid.1
            ...
            public int diff(CaptureFormat.FramerateRange range) {
                ...
                int maxFpsError = progressivePenalty(Math.abs((requestedFps * 1000) - range.max), MAX_FPS_DIFF_THRESHOLD, 1, MAX_FPS_HIGH_DIFF_WEIGHT);
