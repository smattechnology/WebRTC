...
/* loaded from: input.aar:classes.jar:org/webrtc/voiceengine/WebRtcAudioEffects.class */
public class WebRtcAudioEffects {
    ...
    private static boolean isAcousticEchoCancelerExcludedByUUID() {
        ...
        for (int i = DEBUG; i < length; i++) {
            AudioEffect.Descriptor d = availableEffects[i];
    ...
    private static boolean isEffectTypeAvailable(UUID effectType) {
        ...
        for (int i = DEBUG; i < length; i++) {
            AudioEffect.Descriptor d = effects[i];
